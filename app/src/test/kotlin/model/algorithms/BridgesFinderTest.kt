...
import model.algorithms.BridgesFinder
...
class BridgesFinderTest {
    ...
    inner class `All bridges should be found`() {
        ...
        fun `if graph has one edge`(graph: UndirectedGraph<Int>) {
            ...
            val actualBridges = bridgesFinder.findBridges(graph)
        ...
        fun `if graph is chain-like`(graph: UndirectedGraph<Int>) {
            ...
            val actualBridges = bridgesFinder.findBridges(graph).toSet()
